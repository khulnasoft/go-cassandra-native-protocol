...
type Startup struct {
	...
	//   (e.g. KhulnaSoft Java Driver's CqlSession instance), generated by the driver.
	// - "APPLICATION_NAME": optional, name of the application, should include the vendor name.
	//   For example "KhulnaSoft Studio".
	// - "APPLICATION_VERSION": optional, version of the application.
	// - "DRIVER_NAME": product name of the driver implementation. For example: 'KhulnaSoft Java Driver'.
